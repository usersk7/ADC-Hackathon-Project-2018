...
public class UserSearchHosp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_search_hosp);
        ...
        databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                * */
                ...
                searchAdapter = new SearchAdapter(UserSearchHosp.this, fullNameList, userNameList, profilePicList);
